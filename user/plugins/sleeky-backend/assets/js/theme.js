...
$( document ).ready(function() {
  ...
  // Update favicon
  $('link[rel="shortcut icon"]').attr('href', url + "/assets/img/favicon.png");
  ...
  if ($("body").hasClass("login")) {
    ...
    if (theme == "light") {
      $("#login").prepend(`<img class="login-logo" src="${url}/assets/img/logo_ln.png">`);
    } else if (theme == "dark") {
      $("#login").prepend(`<img class="login-logo" src="${url}/assets/img/logo_ln.png">`);
    }
  ...
  function handleNav() {
    // Add logo
    $("#wrap").prepend(`<img class="logo" src="${url}/assets/img/logo_ln_transparan.png">`);
    ...
    $('#admin_menu').append('<li class="admin_menu_toplevel frontend_link"><a href="/"></a></li>');
