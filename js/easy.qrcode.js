...
(function() {
    ...
    var Drawing = useSVG ? svgDrawer : !_isSupportCanvas() ? (function() {
        ...
        ;var Drawing = function(el, htOption) {
            ...
            this._elCanvas.width = 200;
            this._elCanvas.height = 200;
        ...
        Drawing.prototype.draw = function(oQRCode) {
            ...
            for (var row = 0; row < nCount; row++) {
                for (var col = 0; col < nCount; col++) {
                    ...
                    _oContext.strokeRect(Math.floor(nLeft) + 0.5, _htOption.titleHeight + Math.floor(nTop) + 0.5, nRoundedWidth, nRoundedHeight);
                    _oContext.strokeRect(Math.ceil(nLeft) - 0.5, _htOption.titleHeight + Math.ceil(nTop) - 0.5, nRoundedWidth, nRoundedHeight);
                }
            }
            if (_htOption.title) {
